...
var Offline = class {
  ...
  constructor(options = {}) {
    ...
    this.offlineEventStore = import_localforage.default.createInstance({
...
var ReportingObserver = class {
  ...
  setupOnce(_, getCurrentHub) {
    ...
    const observer = new WINDOW2.ReportingObserver(this.handler.bind(this), {
      buffered: true,
