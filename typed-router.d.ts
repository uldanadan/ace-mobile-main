...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    '/balance/[slug]': RouteRecordInfo<'/balance/[slug]', '/balance/:slug', { slug: ParamValue<true> }, { slug: ParamValue<false> }>,
    '/balance/addBalance': RouteRecordInfo<'/balance/addBalance', '/balance/addBalance', Record<never, never>, Record<never, never>>,
    '/balance/addCard': RouteRecordInfo<'/balance/addCard', '/balance/addCard', Record<never, never>, Record<never, never>>,
    '/balance/fill': RouteRecordInfo<'/balance/fill', '/balance/fill', Record<never, never>, Record<never, never>>,
    '/balance/history': RouteRecordInfo<'/balance/history', '/balance/history', Record<never, never>, Record<never, never>>,
    ...
    '/clubs/review': RouteRecordInfo<'/clubs/review', '/clubs/review', Record<never, never>, Record<never, never>>,
    ...
    '/password/change': RouteRecordInfo<'/password/change', '/password/change', Record<never, never>, Record<never, never>>,
